...
f''' After speaking, <Subject 1> {prompt} They continue to move naturally for the remainder of the video. {"<Picture 2> is the last frame of [Shot 1]" if end_image else ''} static \n overall_soundscape: {audio_desc} ''') 
