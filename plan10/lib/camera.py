...
from plan10.lib.compositor import _classify_scene
...
from plan10.lib.image_edit import ImageEdit
from plan10.lib.image_gen import add_metadata_char, GenerateImage
from plan10.lib.util import video_to_img, wait_for_file
...
Do not track or follow the subject. The subject does not move.'''
    ...
    if args.movement:
        GenerateVideo(prompt='Camera moves to a new field of view', media=[args.images[0], args.output], output=args.output.replace('png','mp4'), 
