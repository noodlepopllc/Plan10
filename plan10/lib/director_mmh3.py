...
def main():
    ...
    if args.input:
        ...
        # --- SHOTS ---
        shot | Sound of roosters, as The camera pushes in on blondie is standing near the doorway inside barn holding a treat and red stands beside her with her arms crossed.
