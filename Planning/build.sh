...
python Planning/beat_expansion.py "$(cat "$1")" 8 > Planning/outputs/visual_prompt.txt
...
DIALOG_PROMPT=$(python Planning/dialog_headshot.py "$1" Planning/outputs/registry.json 6)
