...
def main():
    ...
    7. PROP EXTRACTION (APPLY ONLY TO TYPE="action"):
      • Scan each [ACTION] line for physical objects, furniture, or interactive items explicitly mentioned.
      • Extract them into a concise comma-separated string assigned to the "props" field.
      • Format: "glowing Image Comics book, wooden table, Vertigo graphic novel".
      • If no physical objects are mentioned, set props: null. NEVER invent props.
    8. ORDERING: Maintain exact narrative sequence. Do not skip, merge, or reorder lines.
