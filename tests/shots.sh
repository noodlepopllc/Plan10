...
shot "$BG_REV" "$B" "$A" "two_shot" "The women are facing towards the viewer engaging with them, waving and smiling happily" "master_close_rev" "hair gently swaying, subtle posture tension"
